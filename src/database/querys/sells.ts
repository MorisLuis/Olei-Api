...
export const sellsQuery = {
    ...
    getSells: `
        ...
        cte_result AS (
            ...
            GROUP BY c.Id_Cliente, v.Id_Almacen, v.TipoDoc, v.Serie, v.Folio, v.Fecha
        )
    ...
    getSellById: `
        ...
        FROM dbo.VENTAS V
            ...
            JOIN [dbo].[TIPODOCS] TD ON TD.TipoDoc = @TipoDoc
        WHERE V.Id_Almacen = @Id_Almacen AND V.TipoDoc = @TipoDoc AND V.Serie = @Serie AND V.Folio = @Folio
        `,
