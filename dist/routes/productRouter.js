...
// Web endpoints
router.get("/", validateJWT_1.validateJWTWeb, productsWeb_1.getProducts);
router.get("/web/:id", validateJWT_1.validateJWTWeb, productsWeb_1.getProducByIdWeb);
router.get("/count", validateJWT_1.validateJWTWeb, productsWeb_1.getTotalProducts);
router.get("/search", validateJWT_1.validateJWTWeb, productsWeb_1.searchProduct);
// App endpoints
