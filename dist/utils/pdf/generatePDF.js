...
const generatePDF = async (sells, briefSells) => {
                ...
                : col.text.toLowerCase().includes('folio')
                    ...
                    : col.text.toLowerCase().includes('tipo')
                        ...
                        : col.text.toLowerCase().includes('días')
                            ? 'expiredDays'
                            : 'saldo';
        const truncatedHeader = (0, truncateText_1.truncateText)(col.text, maxWidths[key], helveticaBoldFont, headerFontSize);
    ...
    for (let i = 0; i < sells.length; i++) {
        ...
        const fechaText = (0, truncateText_1.truncateText)(fecha, maxWidths.fecha, helveticaFont, rowFontSize);
        ...
        const folioText = (0, truncateText_1.truncateText)(sell.Folio.toString(), maxWidths.folio, helveticaFont, rowFontSize);
        ...
        const tipoDocText = (0, truncateText_1.truncateText)(tipoDoc, maxWidths.tipoDoc, helveticaFont, rowFontSize);
        ...
        const expiredText = (0, truncateText_1.truncateText)(diasVencidos.toString(), maxWidths.expiredDays, helveticaFont, rowFontSize);
        ...
        const saldoText = (0, truncateText_1.truncateText)(saldo, maxWidths.saldo, helveticaFont, rowFontSize);
