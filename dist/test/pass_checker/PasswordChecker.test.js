...
describe('PasswordChecker test suite', () => {
    ...
    it('Password with less than 8 chars are invalid', () => {
        ...
        expect(actual.reasons).toContain(PasswordChecker_1.PasswordErrorsConst.SHORT);
    });
    ...
    it('Password with no upper case letter is invalid', () => {
        ...
        expect(actual.valid).toBe(false);
        expect(actual.reasons).toContain(PasswordChecker_1.PasswordErrorsConst.NO_UPPER_CASE);
    });
    ...
    it('Password with no lower case letter is invalid', () => {
        const actual = sut.checkPassword('1234ABCD');
        expect(actual.valid).toBe(false);
        expect(actual.reasons).toContain(PasswordChecker_1.PasswordErrorsConst.NO_LOWER_CASE);
    });
    ...
    it('Admin password with no number is invalid', () => {
        ...
        expect(actual.valid).toBe(false);
        expect(actual.reasons).toContain(PasswordChecker_1.PasswordErrorsConst.NO_NUMBER);
    });
